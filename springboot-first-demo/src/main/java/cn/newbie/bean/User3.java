 ...
 */
@PropertySource(value = "classpath:config/application-test3.properties",ignoreResourceNotFound = false,encoding = "utf-8")
@ConfigurationProperties(prefix ="test3.user")
public class User3 {
